...
<body>
    ...
    <section> 
        <div class="container">
            ...
            @foreach($show_password as $key =>$customer)
            <form role="form" action="{{URL::to('/update-forget-password/'.$customer->customer_id)}}" onsubmit="return validateForm()" method="post" enctype="multipart/form-data">
                                    {{ csrf_field() }}
                ...
                <div class="head-footer">
                    ...
                    <div class="header-center">
                           <div class="form-group header-content">
                                ...
                                <input type="password" name="customer_password_old" class="form-control" id="exampleInputEmail1" placeholder="Nhập mật khẩu cũ">
                            </div>
                            <div class="form-group header-content">
                                <label for="exampleInputEmail1">Mật khẩu mới</label>
                                <input type="password" name="customer_password_new" class="form-control" id="exampleInputEmail1" placeholder="Nhập mật khẩu mới">
                            </div>
                            <div class="form-group header-content">
                                <label for="exampleInputEmail1" style="height: 50px;">Nhập lại mật khẩu mới</label>
                                <input  style="height: 50px;" type="password" name="customer_password_new_again" class="form-control" id="exampleInputEmail1" placeholder="Nhập lại mật khẩu mới">
                            </div>
