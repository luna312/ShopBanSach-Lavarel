                        ...
                        <div class="panel-body">
                            ...
                            <div class="position-center">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea style="resize: none" rows="9" class="form-control" name="product_content" id="ckeditor2" placeholder="Nội dung sản phẩm"></textarea>
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Số lượng sản phẩm</label>
                                    <input type="number" name="product_quantity" class="form-control" id="" placeholder="Số lượng sản phẩm">
                                </div>
                                <div class="form-group">
                                		<labels for="exampleInputPassword1">Hiển thị</label>
