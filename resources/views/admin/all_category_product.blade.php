          ...
          <tr>
            ...
            <td>
              <a href="{{URL::to('/edit-category-product/'.$cate_pro->category_id)}}" class="active" ui-toggle-class=""><i class="fa fa-pencil-square-o text-success text-active"></i></a>
               <a onclick="return confirm('Bạn có chắc muốn xóa không @@')" href="{{URL::to('/delete-category-product/'.$cate_pro->category_id)}}" class="active" ui-toggle-class="">
      ...
      <div class="row">
        ...
        <div class="col-sm-7 text-right text-center-xs">                
              <div class="text-center">
                  {{ $all_category_product->appends(['sort' => 'category_id'])->links() }}
              </div> 
        </div>
      </div>
    </footer>
