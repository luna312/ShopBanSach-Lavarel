          ...
          <tr>
            ...
            <td>
              <a href="{{URL::to('/edit-brand-product/'.$brand_pro->brand_id)}}" class="active" ui-toggle-class=""><i class="fa fa-pencil-square-o text-success text-active"></i></a>
               <a onclick="return confirm('Bạn có chắc muốn xóa không @@')" href="{{URL::to('/delete-brand-product/'.$brand_pro->brand_id)}}" class="active" ui-toggle-class="">
      ...
      <div class="row">
        ...
        <div class="col-sm-7 text-right text-center-xs">                
              <div class="text-center">
                  {{ $all_brand_product->appends(['sort' => 'brand_id'])->links() }}
              </div> 
        </div>
      </div>
    </footer>
